...
class Network:
    ...
    def is_at_edge_by_points(self, edges_arr, index1: int, index2: int) -> bool:
        # print("our edge : (", index1, index2, ")")
        for e in edges_arr:
            # print("network edge : (", e.vtx_1.serial_number, e.vtx_2.serial_number, ")")
    ...
    def print_network(self):
        ...
        print("Number of edges:", self.num_of_edges/2)
